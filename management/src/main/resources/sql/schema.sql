...
INSERT INTO `appointment` VALUES (1,1000,'2024-01-27','CARDIOLOGY',_binary '','completed',1,1,1,'1',1),(2,1200,'2024-03-11','CARDIOLOGY',_binary '\0','completed',1,1,2,'1',2),(3,1200,'2024-03-11','CARDIOLOGY',_binary '\0','in-progress',2,1,NULL,'2',NULL),(4,1200,'2024-03-11','CARDIOLOGY',_binary '\0','completed',3,1,3,'3',3);
...
INSERT INTO `appointment_tests` VALUES (1,'2024-01-27','completed',1,2),(2,'2024-03-11','completed',2,1),(3,'2024-03-11','completed',2,1),(4,'2024-03-11','completed',4,1);
...
INSERT INTO `medical_condition` VALUES (1,'head ache','fever','hhhh'),(2,'head ache','fever','Normal'),(3,'head ache','fever','Normal');
...
INSERT INTO `medicine` VALUES (1,'panadol','500 mg',500,30),(2,'paracetamol','1000mg',500,50),(3,'dispirin','100 mg',100,10);
...
INSERT INTO `patient` VALUES ('1','China','2024-03-10','ggdds@cbb.hh','khan','male','1122333'),('2','china','2024-03-11','aaa@com','aaaaaa','male','112504478'),('3','china','2024-03-11','aamir@gmail.com','amir','male','15524700');
...
INSERT INTO `prescription` VALUES (1,200,'2024-01-27','scheduled'),(2,5000,'2024-03-11','completed'),(3,5000,'2024-03-11','completed');
...
INSERT INTO `prescription_medicines` VALUES (1,200,2,3,1),(2,5000,10,1,2),(3,5000,10,1,3);
...
INSERT INTO `result` VALUES (1,'CLEAR',1),(2,'CLEAR',2),(3,'CLEAR',3),(4,'CLEAR',4);
...
INSERT INTO `test` VALUES (1,'Inspection','take blood sample and look for white cells','nerves test',100),(2,'Disposal','take blood sample and look for white cells','x-ray test',100);
...
INSERT INTO `transaction` VALUES (1,1000,'2024-01-27',1,'paid','appointment','1'),(2,100,'2024-01-27',1,'paid','test','1'),(3,200,'2024-01-27',1,'valid','medicine','1'),(4,1200,'2024-03-11',2,'paid','appointment','1'),(5,100,'2024-03-11',2,'paid','test','1'),(6,5000,'2024-03-11',2,'paid','medicine','1'),(7,100,'2024-03-11',3,'paid','test','1'),(8,1200,'2024-03-11',3,'paid','appointment','2'),(9,1200,'2024-03-11',4,'paid','appointment','3'),(10,100,'2024-03-11',4,'paid','test','3'),(11,5000,'2024-03-11',3,'paid','medicine','3');
...
INSERT INTO `users` VALUES (1,'CARDIOLOGY','doctor1@test.com','Hammad','test','doctor'),(2,'NEUROLOGY','doctor2@test.com','Sarah','test','doctor'),(3,'N/A','receptionist1@test.com','Emily','test','receptionist'),(4,'N/A','receptionist2@test.com','James','test','receptionist'),(5,'N/A','pharmacist1@test.com','Alex','test','pharmacist'),(6,'N/A','pharmacist2@test.com','Olivia','test','pharmacist'),(7,'INSPECTION','labtech1@test.com','Ethan','test','lab_technician'),(8,'DISPOSAL','labtech2@test.com','Ava','test','lab_technician');
